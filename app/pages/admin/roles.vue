<template>
    <div class="roles-page">
        ...
        <div class="roles-page__grid">
            <div v-for="role in roles" :key="role.id" class="roles-page__card">
                <div class="roles-page__card-header">
                    ...
                    <UButton v-if="!role.isSystem" size="xs" variant="ghost" color="error" icon="i-lucide-trash-2"
        ...
        <UModal v-model:open="showNew" :title="$t('roles.new')">
            <template #body>
                <UForm :state="newRole" @submit="createRole">
                    <UFormField :label="$t('roles.name')">
                        <UInput v-model="newRole.name" />
                    </UFormField>
                    <UFormField :label="$t('roles.description')">
                        <UInput v-model="newRole.description" />
                    </UFormField>
